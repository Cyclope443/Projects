                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="code.php" method="POST">
                                    ...
                                    <div class=" row mb-3">
                                        ...
                                        <div class="col-6">
                                            <b>Evidence :</b> <br>
                                            <img src='evidence/<?= $crime_rep['Evidence'];?>' height=80  width=120 class='img-thumbnail' class="form-control" >
                                        </div>
                                    ...
                                    <div class="row card-footer mx-2 ">
                                            <button type="submit" name="update_comp" class="btn btn-primary float-right">Update</button>
                                            <a href="crimes.php" class="btn btn-danger float-right mx-2">BACK</a>
                                    </div>    
